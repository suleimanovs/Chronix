...
object ChronixDarkColors : ChronixColorScheme {
    override val primary: Color = Color(0xFF4CAF50) // Green
    override val onPrimary: Color = Color(0xFF1B5E20) // Dark Green
    override val primaryContainer: Color = Color(0xFF1B5E20) // Dark Green
    override val onPrimaryContainer: Color = Color(0xFFC8E6C9) // Light Green
    override val inversePrimary: Color = Color(0xFFC8E6C9) // Light Green
    override val secondary: Color = Color(0xFFFF9800) // Orange
    override val onSecondary: Color = Color(0xFFE65100) // Dark Orange
    override val secondaryContainer: Color = Color(0xFFE65100) // Dark Orange
    override val onSecondaryContainer: Color = Color(0xFFFFE0B2) // Light Orange
    override val tertiary: Color = Color(0xFF009688) // Teal
    override val onTertiary: Color = Color(0xFF004D40) // Dark Teal
    override val tertiaryContainer: Color = Color(0xFF004D40) // Dark Teal
    override val onTertiaryContainer: Color = Color(0xFFB2DFDB) // Light Teal
    override val background: Color = Color(0xFF121212) // Dark Gray
    override val onBackground: Color = Color(0xFFFFFFFF) // White
    override val surface: Color = Color(0xFF121212) // Dark Gray
    override val onSurface: Color = Color(0xFFFFFFFF) // White
    override val surfaceVariant: Color = Color(0xFF424242) // Dark Gray
    override val onSurfaceVariant: Color = Color(0xFFBDBDBD) // Gray
    override val surfaceTint: Color = primary // Green
    override val inverseSurface: Color = Color(0xFFFFFFFF) // White
    override val inverseOnSurface: Color = Color(0xFF000000) // Black
    override val error: Color = Color(0xFFD32F2F) // Red
    override val onError: Color = Color(0xFFB71C1C) // Dark Red
    override val errorContainer: Color = Color(0xFFB71C1C) // Dark Red
    override val onErrorContainer: Color = Color(0xFFFFCDD2) // Light Red
    override val outline: Color = Color(0xFF9E9E9E) // Darker Gray
    override val outlineVariant: Color = Color(0xFF757575) // Gray
    override val scrim: Color = Color(0xFF000000) // Black
    override val surfaceBright: Color = Color(0xFF1E1E1E) // Very Dark Gray
    override val surfaceContainer: Color = Color(0xFF2C2C2C) // Dark Gray
    override val surfaceContainerHigh: Color = Color(0xFF383838) // Dark Gray
    override val surfaceContainerHighest: Color = Color(0xFF424242) // Dark Gray
    override val surfaceContainerLow: Color = Color(0xFF1E1E1E) // Very Dark Gray
    override val surfaceContainerLowest: Color = Color(0xFF2C2C2C) // Dark Gray
    override val surfaceDim: Color = Color(0xFF424242) // Dark Gray
}